...
class BatchLoaderVqa:
    def __init__(self, imdb, data_params):
        ...
        ##self.feat_H, self.feat_W, self.feat_D = feats.shape[0:]
        self.feat_D, self.feat_H, self.feat_W = feats.shape[0:]
    ...
    def load_one_batch(self, sample_ids):
        ...
        for n in range(len(sample_ids)):
            ...
            image_feat_batch[n:n+1] = np.load(iminfo['feature_path']).transpose([1,2, 0])
...
class DataReader:
    def __init__(self, imdb_file, shuffle=True, one_pass=False, prefetch_num=8, **kwargs):
        ...
        # {'T_decoder': 13,
        #  'T_encoder': 26,
        #  'assembler': <models_vqa.nmn3_assembler.Assembler object at 0x7fcb1e5f8d68>,
        #  'batch_size': 1,
